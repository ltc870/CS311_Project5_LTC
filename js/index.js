...
// resetButton, formContainer, formButton variables
...
const generateMadLib = function () {
  // madLib variables for each input
  ...
  // madLib variable that contains the mad lib
  ...
  // formContainer innerHTML to change to madLib
  formContainer.innerHTML = ` <div class="madlib">${madLib}</div>`;

  // appends the button to the formContainer
  formContainer.appendChild(resetButton);

  // resetButton innerHTML and classList
